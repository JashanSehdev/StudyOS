...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-4"
      style={{
        backgroundImage: `radial-gradient(ellipse at 60% 20%, #6C63FF22 0%, transparent 60%),
                          radial-gradient(ellipse at 20% 80%, #6C63FF11 0%, transparent 50%)`
      }}
    >
      <div className="w-full max-w-md">
        ...
        >
          ...
          <p className="text-gray-500 text-sm mb-8">Log in to your academic cockpit</p>
